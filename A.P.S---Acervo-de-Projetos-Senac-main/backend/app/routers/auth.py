...
# RF01 — cadastro somente com e-mail institucional
DOMINIOS_PERMITIDOS = ("@aluno.senac.br", "@senac.br", "@senacpe.edu.br")

@router.post("/register", response_model=TokenOut)
def register(data: UsuarioCreate, db: Session = Depends(get_db)):
    if not data.email.lower().endswith(DOMINIOS_PERMITIDOS):
        raise HTTPException(status_code=400, detail="Utilize seu e-mail institucional do Senac")
